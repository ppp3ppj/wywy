...
func EmailInlineValidation(isValidated bool, email string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if isValidated {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/auth_views/register_components/email_inline_validation.templ`, Line: 18, Col: 33}
			}
			...
			if len(strings.TrimSpace(email)) == 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/auth_views/register_components/email_inline_validation.templ`, Line: 32, Col: 37}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/auth_views/register_components/email_inline_validation.templ`, Line: 48, Col: 37}
				}
